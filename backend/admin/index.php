<?php
    ...
    if(isset($_POST['admin_login']))
    {
        ...
        // Verify reCAPTCHA
    $recaptcha_secret_key = '6LdbgyopAAAAAHgcV49UcPImWKIMdbfb5N_KppDA';
...
<head>
        ...
        <style>
        body {
            background: radial-gradient(circle, #ff3399, #9933cc);
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <div class="g-recaptcha" data-sitekey="6LdbgyopAAAAADnSQz5yhOVuBwySbNbq4Ex2AfKh"> </div>
