<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "INSERT INTO his_patients (pat_fname, pat_ailment, pat_lname, pat dob, pat_age, pat_number, pat_phone, pat_type, pat_addr) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $mysqli->prepare($query);
    
        // Bind parameters
        $rc = $stmt->bind_param('ssssssss', $pat_fname, $pat_ailment, $pat_lname, $pat_dob, $pat_age, $pat_number, $pat_phone, $pat_type, $pat_addr);
